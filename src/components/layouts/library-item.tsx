...
const navigate = useNavigate();
  ...
  return (
    <div className="flex w-full cursor-pointer items-center gap-x-3 rounded-sm p-2 hover:bg-neutral-800/50"  onClick={handleChooseItem}>
      <div className="relative min-h-[80px] min-w-[80px] overflow-hidden rounded-md">
        <img
