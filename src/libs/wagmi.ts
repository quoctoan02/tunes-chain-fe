import { WALLET_CONNECT_PROJECT_ID } from "@/configs/app.config"
...
export const { publicClient, webSocketPublicClient, chains } = configureChains(supportedChains, [publicProvider()])
